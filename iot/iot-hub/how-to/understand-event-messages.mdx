...
- `service level: message payload is too large`: See [limitations](https://www.scaleway.com/en/docs/scaleway-iothub/#-IoT-Hub-Beta-Limitations) for the maximum allowed messages payload size.
